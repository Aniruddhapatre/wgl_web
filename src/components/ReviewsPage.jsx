...
const ReviewsPage = () => {
  ...
  const toggleMute = () => {
    ...
    // if unmuting and volume is zero, set a sensible default
  ...
  const handleVolumeChange = (e) => {
    ...
    // if user sets volume > 0, ensure unmuted
            ...
            {testimonialData.map((item, index) => (
              ...
              >
                <div
                  ...
                  className={`rounded-3xl select-none overflow-hidden w-full sm:w-[360px] h-[340px] sm:h-[440px] relative bg-gradient-to-br from-zinc-800 via-zinc-900 to-black shadow-2xl group transition-all duration-300 hover:border-2 hover:border-lime-300 ${
          ...
          <div className="relative h-[80vh] w-[calc(80vh*9/16)] max-w-[90vw]">
            ...
            <div className="absolute top-4 right-4 z-50 flex flex-col gap-2 items-end">
              <div className="flex gap-2 items-center">
                ...
                {/* Volume & slider wrapper (hover keeps slider) */}
                <div
                ...
                >
                  ...
                  {showVolumeControl && (
                    <div className="absolute right-0 top-full m-2 bg-black/80 rounded-lg p-2 h-32 flex items-center justify-center">
                      <input
                        type="range"
                        min="0"
                        max="1"
