...
const InternshipPage = () => {
  ...
  return (
    <div className="relative sm:pt-12 text-white min-h-screen select-none">
      ...
      <div className="relative z-10">
        ...
        <div className="min-h-[70vh] flex flex-col items-center justify-center p-4 text-center animate-fade-in-down">
          <div className="bg-black/10 backdrop-blur-sm p-8 md:p-12 rounded-2xl max-w-4xl">
            ...
            <button
            onClick={() => setIsModalOpen(true)}
            className="relative inline-block group font-bold text-lg sm:text-lg sm:px-6 px-2 py-4 sm:rounded-3xl rounded-full border border-green-700 bg-gradient-to-r from-green-500 to-green-600 shadow-lg overflow-hidden"
          >
        ...
        <div className="py-20 sm:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center animate-slideInLeft">
              {/* <h2 className="text-base font-semibold text-lime-400 tracking-wider uppercase">
                Our Mission
              </h2> */}
            ...
            <div className="mt-16 grid gap-10 sm:grid-cols-2 lg:grid-cols-4 animate-slideInRight">
              {aboutNgo.whyJoin.points.map((point) => (
                <div
                  key={point.title}
                  className="bg-[#09513A] rounded-lg p-4 sm:p-6 shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 hover:-translate-y-2"
                >
                  <div className="flex items-center justify-center h-12 w-12 rounded-md bg-emerald-700 mb-6">
                    <CheckCircleIcon className="h-8 w-8 text-lime-400" />
                  </div>
